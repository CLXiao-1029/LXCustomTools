...
{
    public partial class LXCustomTextBox : TextBox
    {
        /// <summary> 
        /// 获得当前进程，以便重绘控件 
        /// </summary> 
        ...
        /// </summary> 
        [Category("自定义属性"),
        Description("设置边框大小。只在控件的BorderStyle为FixedSingle和Fixed3D时有效"),
        DefaultValue(1)]
        ...
        /// </summary> 
        [Category("自定义属性"),
        Description("获得或设置一个值，指示当鼠标经过控件时控件边框是否发生变化。只在控件的BorderStyle为FixedSingle和Fixed3D时有效"),
        DefaultValue(true)]
        ...
        /// </summary> 
        [Category("自定义属性"),
       Description("获得或设置控件的边框颜色。只在控件的BorderStyle为FixedSingle和Fixed3D时有效"),
       DefaultValue(typeof(Color), "#A7A6AA")]
        ...
        /// </summary> 
        [Category("自定义属性"),
       Description("获得或设置当鼠标经过控件时控件的边框颜色。只在控件的BorderStyle为FixedSingle和Fixed3D时有效"),
       DefaultValue(typeof(Color), "#335EA8")]
        ...
        public LXCustomTextBox()
        {
            InitializeComponent();
        }

        public LXCustomTextBox(IContainer container)
        {
            container.Add(this);
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (m.Msg == 0xf || m.Msg == 0x133)
            {
                ...
                //只有在边框样式为FixedSingle和Fixed3D时自定义边框样式才有效 
                if (this.BorderStyle != BorderStyle.None)
                {
                    //边框Width为1个像素 
                    Pen pen = new Pen(this._BorderColor, _BorderSize); 
